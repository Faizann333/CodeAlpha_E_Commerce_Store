...
const ProductCard = ({ product, isAdmin }) => {
  ...
  return (
    <div className="border-2 border-purple-600 bg-gray-700  rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden w-[280px] flex flex-col">
      ...
      <div className="flex flex-col text-white flex-grow p-4">
        ...
        <button
          ...
          className="mt-auto bg-black text-white py-2 rounded-xl hover:bg-gray-800 transition duration-300 font-medium"
        >
          View Details
        </button>
        <div>
