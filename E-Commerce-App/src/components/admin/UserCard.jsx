...
const UserCard = ({ user }) => {
  return (
    <div className="flex flex-col item-center sm:flex-row bg-gray-800 border-purple-700  border-3 shadow-md rounded-xl p-6 hover:shadow-lg transition h-[230px] sm:h-[100px] w-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center  w-full gap-2">
        ...
        <Button name="Delete" className= "bg-red-500 w-[200px] text-black"/>
      </div>
    </div>
  );
};
